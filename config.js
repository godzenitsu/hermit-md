...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '05_21_H_E_R_M_I_T_S7KIQBA',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ɴᴇᴢᴜᴋᴏ',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐍𝐄𝐙𝐔𝐊𝐎 𝐌𝐃;𝐆𝐎𝐃 𝐙𝐄𝐍𝐈𝐓𝐒𝐔;917907387121;https://i.imgur.com/imOAWEN.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '𝐍𝐄𝐙𝐔𝐊𝐎 𝐌𝐃;𝐆𝐎𝐃 𝐙𝐄𝐍𝐈𝐓𝐒𝐔;https://i.imgur.com/o3AEXEj.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐍𝐄𝐙𝐔𝐊𝐎 𝐌𝐃;𝐆𝐎𝐃 𝐙𝐄𝐍𝐈𝐓𝐒𝐔' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '917907387121,0',
       DEBUG: DEBUG
};
